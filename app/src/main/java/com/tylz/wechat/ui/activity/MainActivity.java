...
import com.tylz.wechat.ui.adapter.CommonFragmentPagerAdapter;
import com.tylz.wechat.ui.base.BaseActivity;
import com.tylz.wechat.ui.base.BaseFragment;
import com.tylz.wechat.ui.fragment.FragmentFactory;
import com.tylz.wechat.ui.presenter.MainAtPresenter;
import com.tylz.wechat.ui.view.IMainAtView;
import com.tylz.wechat.util.PopupWindowUtils;
...
public class MainActivity extends BaseActivity<IMainAtView,MainAtPresenter> implements IMainAtView, ViewPager.OnPageChangeListener {
    ...
    public void initView() {
       ...
       // showWaitingDialog(UIUtils.getString(R.string.please_wait));
        ...
        mTvMessagePress.setTextColor(Color.argb(255,69,192,26));

        //设置ViewPager的最大缓存页面 左边可以加载3个右边可以加载三个
