...
public class SplashActivity extends BaseActivity {
    ...
    public void init() {
        PermissionGen.with(this).addRequestCode(100).permissions(
                        ...
                        Manifest.permission.WRITE_SETTINGS).request();
    ...
    public void initListener() {
        mBtnRegister.setOnClickListener(v ->jumpToActivity(RegisterActivity.class));
        mBtnLogin.setOnClickListener(v->jumpToActivity(LoginActivity.class));
    }
